        ...
        <ul className="pt-6">
          ...
          {(authDisabled || User?.roles == 'super_admin') &&
            <div className={`transition-all duration-300 ease-in-out ${DataMaster ? 'px-3 py-2 flex flex-col border-l-2 border-white rounded-b-xl ml-2  max-h-screen opacity-100' : 'max-h-0 opacity-0 pointer-events-none'}`}>
              ...
              <Link href="/DataMaster/programprioritasdaerah">
                <li className={`flex items-center gap-x-2 cursor-pointer p-2 rounded-xl transition-all duration-300 ease-in-out ${url === "/DataMaster/programprioritasdaerah" ? "bg-white text-gray-800" : "hover:bg-slate-500"}`}>
