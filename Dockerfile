...
ARG NEXT_PUBLIC_API_URL_RENAKSI_OPD
ENV NEXT_PUBLIC_API_URL_RENAKSI_OPD=${NEXT_PUBLIC_API_URL_RENAKSI_OPD}
...
ARG NEXT_PUBLIC_LINK_MANUAL_USER
ENV NEXT_PUBLIC_LINK_MANUAL_USER=${NEXT_PUBLIC_LINK_MANUAL_USER}
...
ARG NEXT_PUBLIC_API_URL_CASCADING_PEMDA
ENV NEXT_PUBLIC_API_URL_CASCADING_PEMDA=${NEXT_PUBLIC_API_URL_CASCADING_PEMDA}
